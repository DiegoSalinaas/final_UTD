<div class="container my-4">
  ...
  <div class="d-flex justify-content-between align-items-center mb-3">
    <h3 class="mb-0 text-primary fw-bold d-flex align-items-center">
      <i class="bi bi-inboxes me-2"></i> Listado de Recepciones
    </h3>
    <div class="d-flex align-items-center gap-2">
      <span class="badge text-bg-light border shadow-sm">
        Total: <strong id="recepcion_count" class="ms-1">0</strong>
      </span>
  ...
  <div class="card shadow rounded-4 border-0">
    <div class="card-body">
      ...
      <div class="row g-3 align-items-end">
        <div class="col-md-6">
          <label for="b_recepcion" class="form-label fw-semibold">Buscar</label>
          <div class="input-group">
            <span class="input-group-text"><i class="bi bi-search"></i></span>
            <input type="text" id="b_recepcion" class="form-control" placeholder="Cliente, teléfono, dirección…">
