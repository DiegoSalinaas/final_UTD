    ...
    <div class="card-body p-4">
      ...
      <div class="row g-4 align-items-end mb-1">
        ...
        <div class="col-md-2">
          ...
          <input type="number" step="0.01" id="precio_unitario_txt" class="form-control text-end" inputmode="decimal" placeholder="0">
        </div>
...
<!-- Helpers mínimos (puedes quitar si ya los tenés globales) -->
<script>
